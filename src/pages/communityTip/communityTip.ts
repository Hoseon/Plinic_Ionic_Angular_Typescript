...
@IonicPage()
@Component({
  selector: 'page-community-tip',
  templateUrl: 'communityTip.html',
})
export class CommunityTipPage {
        ...
        popover.onDidDismiss(popoverData => {
          if (popoverData === "조회순") {
            setTimeout(() => {
              ...
              this.getPostListSortView();
            }, 100)
          }
          else if (popoverData === "최신순") {
            setTimeout(() => {
              this.sortButton = false;
              this.getPostListSortCreate();
            }, 100)
          } else {
            setTimeout(() => {
              this.sortButton = true;
      ...
      if (this.platform.is('ios')) {
        ...
        popover.onDidDismiss(popoverData => {
          if (popoverData === "조회순") {
            setTimeout(() => {
              this.sortButton = true;
              this.getPostHitListSortView();
            }, 100)
          }
          else if (popoverData === "최신순") {
            setTimeout(() => {
              this.sortButton = false;
              this.getPostHitListSortCreate();
            }, 100)
          } else {
            setTimeout(() => {
              this.sortButton = true;
  ...
  getPostListSortView() {
    this.images.postListSortView().subscribe(data => {
      this.communityBeautyLoadData = data;
    }, error => {
  ...
  getPostListSortCreate() {
    this.images.postListSortCreate().subscribe(data => {
      this.communityBeautyLoadData = data;
    }, error => {
  ...
  getPostHitListSortView() {
    this.images.postHitListSortView().subscribe(data => {
      this.communityBeautyLoadData = data;
    }, error => {
  ...
  getPostHitListSortCreate() {
    this.images.postHitListSortCreate().subscribe(data => {
      this.communityBeautyLoadData = data;
    }, error => {
