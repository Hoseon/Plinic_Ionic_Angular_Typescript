  ...
  } from '../registercomplete/registercomplete';
  import {
    SelectSearchableComponent
  } from 'ionic-select-searchable';
  import {
    ImagesProvider
  } from '../../../providers/images/images';
  ...
  export class AddinfoPage {
    ...
    constructor(
      ...
      if (navParams.get('snsUserdata')) {
        this.snsUserData = navParams.get('snsUserdata');
        this.email = navParams.get('snsUserdata').email;
      }

      if (navParams.get('ispush')) {
        this.isPush = navParams.get('ispush');
      }
      ...
      this.simpleColumns = [{
        ...
        options: [{
          ...
          {
            text: 'European_Communities',
            value: 'European_Communities'
          },
          {
            text: 'Finland',
            value: 'Finland'
    ...
    ngOnInit() {
      ...
      //   name: new FormControl('', [Validators.required, Validators.minLength(2), Validators.maxLength(10), Validators.pattern(NAMEPATTERN)])
      // });
    }
    ...
    public register() {
      ...
      if (this.snsUserData) {
        ...
        if (this.snsUserData.from === 'naver') {
          this.registerCredentials.snsid = "naver:".concat(this.snsUserData.id)
        } else if (this.snsUserData.from === 'kakao') {
          this.registerCredentials.snsid = "kk:".concat(this.snsUserData.id);
        } else if (this.snsUserData.from === 'google') {
          this.registerCredentials.snsid = "gg:".concat(this.snsUserData.id);
        }
      }
      ...
      if (this.registerCredentials.imagePath) {
      ...
      if (this.snsUserData) {
        this.auth.registerSnS(this.registerCredentials).subscribe(success => {
          this.loading.dismiss();
            if (success !== '') {
    ...
    public phonenumber_delete() {
      console.log('phonenumber_delete');
