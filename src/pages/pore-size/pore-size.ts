...
export class PoreSizePage {
  ...
  randomTip : any = [
    ...
    {"_id":{"$oid":"60050f06cd7599a9641352c0"},"views":19,"editor":false,"like":0,"likeuser":[""],"visible":true,"body":"[셀럽화장대] 아이돌 나이트 스킨케어","midtext":"걸그룹 씨스타 '소유'님의 잠들기 전 피부관리법이 궁금해!","posturl":"http://naver.me/G2hihzyk","filename":"image-1611640423285","originalName":"210118_4.jpg","author":{"$oid":"6004e920c3ae02a956f129ee"},"numId":20,"showLocation":[{"home":false,"poreSize":true,"poreCount":true,"skinTone":true,"clean":true,"munjin":true,"editor":false,"_id":{"$oid":"600fae67575093ac05748fb3"}}],"tabLocation":[{"tip":false,"hit":true,"new":false,"_id":{"$oid":"600fae67575093ac05748fb4"}}],"comments":[],"createdAt":{"$date":"2021-01-18T04:31:02.030Z"},"created":{"$date":"2021-01-18T04:31:02.030Z"},"__v":0,"updatedAt":{"$date":"2021-01-26T05:53:43.445Z"},"seq":1},
